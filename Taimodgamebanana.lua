...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    UserImage.Image = "rbxassetid://75774010417827"
	...
	Logo.Image = "rbxassetid://75774010417827"
...
NguyenTien:AddLabel("Owner: Tuấn Anh IOS Trùm Skid")
NguyenTien:AddLabel("Tuấn Anh Đẹp Zoai")
NguyenTien:AddLabel("Bố Đây Các Con HaHa")
NguyenTien:AddLabel("Cảm Con Mẹ Nó Ơn Chúng Mầy Đã Dùng Script Của Bố")
...
Notif.New("Đã Copy Link Discord", 5)
end)
NguyenTien:AddButton("YouTube",function()
setclipboard("https://youtube.com/@tuananhios?si=wmFF1ZHNImvFwfpY")
Notif.New("Đã Copy Link YouTube", 5)
end)
NguyenTien:AddButton("Facebook",function()
setclipboard("https://www.facebook.com/share/14EnFhvueYC/?mibextid=wwXIfr")
Notif.New("Đã Copy Link FaceBook", 3)
end)
---- Trang Chá»§
